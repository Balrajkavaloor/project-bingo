    ...
    <div className="space-y-0">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-3xl mx-4 mb-8">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-16 h-16 bg-yellow-400 rounded-full opacity-20 animate-float-numbers flex items-center justify-center text-white font-bold text-lg">B</div>
      ...
      <div className="pointer-events-none">
        ...
        <div className="fixed top-8 left-6 z-10">
          <div className="w-16 h-16 rounded-full bg-yellow-400 shadow-0 shadow-yellow-50/40 border-4 border-white flex items-center justify-center text-white font-black text-xl rotate-[-10deg]">
            12
          </div>
        </div>
